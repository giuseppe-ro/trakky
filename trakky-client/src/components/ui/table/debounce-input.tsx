...
export function DebouncedSelect({
  ...
  return (
    <Select defaultValue="All" onValueChange={(e) => setValue(e)}>
      <SelectTrigger className="w-full justify-between h-6 border-none outline-none bg-slate-800 text-xs p-0 pl-2 md:pr-1 md:py-1 rounded-none overflow-hidden">
